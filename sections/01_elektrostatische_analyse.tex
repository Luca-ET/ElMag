...
\begin{minipage}[c]{0.36\columnwidth}
    ...
    \begin{center}
        \includegraphics[width=0.8\columnwidth]{images/V1B1.png}
    \end{center}
...
\hfill
\begin{minipage}[c]{0.60\columnwidth}
    Das Kurvenintegral des elektrostatischen Feldes hängt nur von der Position des Anfangs- und Schlusspunktes ab.\\
    Es ist unabhängig von der Kurvenform.\\
